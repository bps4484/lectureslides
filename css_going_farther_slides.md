...
The location is "relative" to the file you are displaying.  The Browser does the work to figure this out.
...
* Also note that these 3 different ways to link will always be available when we link to other things
...
The **selector**, `p` in this case, specifies what parts of the HTML document should be styled by the rule. This selector will style all `p` elements on the page.
...
* Stop to show that you can look up any css property that you want with "css [property name] property"
...
Here is the second declaration:
...
* stop to talk a little bit about caniuse.com
